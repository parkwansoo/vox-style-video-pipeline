...
- **광고 편이면 숏츠 자동화의 완성 대본을 표현·후킹 레퍼런스로 참고해
  ...
  대본들이다.
- **광고 편 우회 단어** (2026-08-03 사용자 확정): 대본에서 아래 단어는 쓰지
  않고 우회한다. 우회 표현은 정해두지 않는다 — 문맥에 맞게 자유롭게 창작한다.
  **진피 · 치료 · 완치 · 치유 · 항염 · 염증 완화 · 살균 · 여드름 · 아토피**
  특허번호·수상명·연도 같은 구체 디테일은 쓰지 않아도 된다. 이 목록 밖의
  표현 제한은 없다.
