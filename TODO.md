...
- [ ] 2026-08-02 자막·타이틀 등 정보 레이어를 Remotion으로 얹기 — **2026-08-04 설계 확정, 구현 대기** (숏츠자동화 자막 구현 이식, 흰 글자만·강조색 없음, 기미 2편에도 적용 예정). 상세: [docs/설계-리모션-자막레이어.md](docs/설계-리모션-자막레이어.md)
